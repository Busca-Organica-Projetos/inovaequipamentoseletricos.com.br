...
<html lang="pt-br">
    <head>
        ...
        <link rel="preload" as="image" href="<?php $url ?>imagens/main/home/banner.webp" fetchpriority="high > 
        <link rel="preload" as="style" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossorigin="anonymous" referrerpolicy="no-referrer" onload="this.onload=null;this.rel='stylesheet'">
        ...
        <?php echo !empty($meta_img)?"<meta name=\"twitter:image\" content=\"".$meta_img."\">":"";
        $retorno = '<script type="application/ld+json">
            {
                "@context":"http://schema.org",
                "@type":"LocalBusiness",
                "name":"'.$nome_empresa.'",
                "image":"'.$url.$logo_cliente.'.png",
                "telephone":[';
            ...
            <script type="application/ld+json">
            {
                ...
                "publisher":{
                    ...
                    "image":"'.$url.$logo_buscaorganica.'.png"
                },
            ...
            $retorno .= '   <script type="application/ld+json">
            {
                ...
                $breadcrumbjs = $borg->replace($breadcrumbjs, '},', 0, '}');$retorno .= $breadcrumbjs;$retorno .= ']
            }
            </script>';
